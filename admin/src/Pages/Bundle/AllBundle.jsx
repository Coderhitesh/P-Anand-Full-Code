                        ...
                        {currentItems.map((bundle, index) => {
                            ...
                            return (
                                <tr key={bundle._id}>
                                    ...
                                    <td>{selectedMode ? selectedMode.coursePrice : bundle.bundleTotalPrice}</td>
                                    ...
                                    <td>
                                        <Link style={{ whiteSpace: 'nowrap' }} onClick={() => handleDelete(bundle._id)} className="bt delete">Delete <i className="fa-solid fa-trash"></i></Link>
