...
const EditCategory = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get(`https://api.panandacademy.com/api/v1/single-category/${id}`);
    ...
    const updateCategory = async (data) => {
        try {
            const response = await axios.put(`https://api.panandacademy.com/api/v1/update-category/${id}`, data, {
                headers: {
