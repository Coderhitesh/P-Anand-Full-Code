...
function AddFreeResourceCategory() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setFormData({ name: '' });
            // fetchCategories(); // Refresh the list of categories if needed
        } catch (error) {
            setIsLoading(false);
    ...
    return (
        <>
            ...
            <div className="bread">
                <div className="head">
                    <h4>Add Free Resource Category</h4>
                </div>
                <div className="links">
...
export default AddFreeResourceCategory;
