...
const AllFreeResourceCategory = () => {
  ...
  return (
    <>
      ...
      <div className="bread">
        <div className="head">
          <h4>All Free Resource Categories</h4>
        </div>
        <div className="links">
          <Link to="/add-free-resource-category" className="add-new">
          ...
          <tbody>
            {currentItems.map((category, index) => (
              <tr key={category._id}>
                ...
                <td>{category.name}</td>
                <td>
                  <Link to={`/edit-free-resource-category/${category._id}`} className="bt edit">
...
export default AllFreeResourceCategory;
