...
function EditTeacher() {
  ...
  const fetchTeacher = async () => {
    try {
      const res = await axios.get(`https://api.panandacademy.com/api/v1/single-teacher/${id}`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.put(`https://api.panandacademy.com/api/v1/update-teacher/${id}`, data, {
        headers: {
