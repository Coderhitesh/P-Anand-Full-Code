...
const AllEnquiry = () => {
  ...
  const handleFetch = async () => {
    try {
      const res = await axios.get('https://www.api.panandacademy.com/api/v1/get-all-enquiry');
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://www.api.panandacademy.com/api/v1/delete-enquiry/${selectedId}`);
      handleFetch();
  ...
  return (
    <div className="container mt-5">
      <h1 className="mb-4">All Enquiry Details</h1>
