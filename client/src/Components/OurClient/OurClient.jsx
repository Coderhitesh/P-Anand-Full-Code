      ...
      <section className="testimonial-section fix section-padding pt-0 mt-5">
        <div className="container">
          <div className="section-title text-center">
            <h2 className="mb-3 wow fadeInUp" data-wow-delay=".3s">What Our Students Say</h2>
            <p>Students at P Anand Academy appreciate the expert guidance, encouraging atmosphere, <br />and the academy's unwavering commitment to their academic growth and success.</p>
          </div>
